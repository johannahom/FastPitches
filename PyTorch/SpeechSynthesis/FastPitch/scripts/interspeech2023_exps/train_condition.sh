...
: ${BATCH_SIZE:=32}
: ${GRAD_ACCUMULATION:=1}
: ${OUTPUT_DIR:="/disk/scratch3/jomahony/interspeech2023_models/turn_model"}
: ${DATASET_PATH:=None}
: ${TRAIN_FILELIST:=filelists/interspeech_filelists/interspeech_conditions_train.txt}
: ${VAL_FILELIST:=filelists/interspeech_filelists/interspeech_conditions_val.txt}
: ${AMP:=false}
: ${SEED:=""}
...
: ${PROJECT:=turn_model-interspeech}
: ${EXPERIMENT_DESC:=turn model for interspeech}
