...
: ${BATCH_SIZE:=32}
: ${GRAD_ACCUMULATION:=1}
: ${OUTPUT_DIR:="/disk/scratch3/jomahony/ssw2023_models/fine-tune-ljBase200-candor-ssw-condition"}
: ${DATASET_PATH:=None}
: ${TRAIN_FILELIST:=filelists/ssw2023/candor_condition/ssw_conditions_train.csv}
: ${VAL_FILELIST:=filelists/ssw2023/candor_condition/ssw_conditions_val.csv}
: ${AMP:=false}
: ${SEED:=""}
...
: ${PROJECT:=fine-tune-ljBase200-candor-ssw-condition}
: ${EXPERIMENT_DESC:=conditioned model with fine-tuning from epoch 200 ssw}
