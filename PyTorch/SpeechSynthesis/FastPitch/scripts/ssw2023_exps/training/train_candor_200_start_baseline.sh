...
: ${BATCH_SIZE:=32}
: ${GRAD_ACCUMULATION:=1}
: ${OUTPUT_DIR:="/disk/scratch3/jomahony/ssw2023_models/fine-tune-ljBase200-candor-ssw-baseline"}
: ${DATASET_PATH:=None}
...
: ${PROJECT:=fine-tune-ljBase200-candor-ssw-baseline}
: ${EXPERIMENT_DESC:=baseline model with fine-tuning from epoch 200 ssw}
