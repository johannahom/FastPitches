...
: ${BATCH_SIZE:=16}
: ${GRAD_ACCUMULATION:=1}
: ${OUTPUT_DIR:="/disk/scratch3/jomahony/ssw2023_models"}
: ${DATASET_PATH:=None}
: ${TRAIN_FILELIST:=filelists/ssw2023/lj_baseline/train.csv}
: ${VAL_FILELIST:=filelists/ssw2023/lj_baseline/validation.csv}
: ${AMP:=false}
: ${SEED:=""}
...
: ${PROJECT:=baseline-lj-ssw}
: ${EXPERIMENT_DESC:=baseline model for fine-tuning ssw}
