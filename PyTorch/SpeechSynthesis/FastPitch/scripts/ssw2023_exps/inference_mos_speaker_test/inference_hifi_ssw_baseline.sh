...
: ${PHRASES:="/disk/scratch/s2132904/interspeech_2023/FastPitches/PyTorch/SpeechSynthesis/FastPitch/scripts/ssw2023_exps/inference_mos_speaker_test/inference_pre_mos.tsv"}
: ${BATCH_SIZE:=20}
: ${OUTPUT_DIR:="/disk/scratch3/jomahony/ssw2023_model_inference/inference_mos_speaker_test/${1}/${3}/${2}/"}
