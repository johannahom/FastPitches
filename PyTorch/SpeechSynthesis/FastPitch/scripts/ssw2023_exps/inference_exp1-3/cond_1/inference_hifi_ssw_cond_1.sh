...
: ${PHRASES:="/disk/scratch3/jomahony/ssw2023_model_inference/exp1-3_inference/candor_data/inference_fastpitch/filelists/inference_${1}_${2}_cond_1.tsv"}
: ${BATCH_SIZE:=20}
: ${OUTPUT_DIR:="/disk/scratch3/jomahony/ssw2023_model_inference/exp1-3_inference/inference_ssw_exps_output/${1}/${2}/cond_1/"}
...
: ${SPEAKER:=${2}}
: ${NUM_SPEAKERS:=500}
: ${CONDITION:=1} #where 0 is no label, 1 is turn-medial and 2 is turn-final
: ${NUM_CONDITION:=3}
